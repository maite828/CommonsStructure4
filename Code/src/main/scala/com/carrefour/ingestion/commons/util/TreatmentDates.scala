...
import com.carrefour.ingestion.commons.bean.{FileNamePartitionType, IngestionMetadata, ParameterPartitionType, PartitionType}
import com.carrefour.ingestion.commons.service.impl.ExtractServiceImpl.{endLog, infoLog, initLog, warnLog}
